...
int main(int argc, char *argv[]){
    ...
    //LETS DO SOME SECRET STUFF TO MAKE THIS BOMB UNDEFUSABLE
    bomb_setup();
    ...
    printf("STAGE 3\n");
    printf("LETS SEE IF YOU CAN FIGURE OUT THE RIGHT COMBINATION OF 3 CHARACTERS THAT PRODUCE THE FLAG\n");
    input = reader();
    stage3(input);
